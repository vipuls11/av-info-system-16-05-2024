...
const ATXCabinets = () => {
    ...
    const filteredMonitors = filterProductsByName("ATX Cabinets");
    ...
    return (
        <>
            <div className="w-[90%] m-auto my-5">
                <h2 className='text-center my-10 text-4xl py-5 font-bold'>ATX Cabinets</h2>
                <div>
