...
const ExternalCasingandWiFi = () => {
    ...
    const filteredMonitors = filterProductsByName("External Casing and WiFi");
    ...
    return (
        <>
            <div className="w-[90%] m-auto my-5">
                <h2 className='text-center my-10 text-4xl py-5 font-bold'>MotherBoard</h2>
                <div>
...
export default ExternalCasingandWiFi