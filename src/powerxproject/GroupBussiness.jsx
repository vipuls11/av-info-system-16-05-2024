        ...
        <div className="bg-[#E7E7E7] py-10">
            <div className="w-[90%] m-auto">
                ...
                <div className='grid lg:grid-cols-4 md:grid-cols-2 gap-5 '>
                    {Grouplist.map(items => {
                        return <div key={items.id} className='p-1 bg-white overflow-hidden grid place-content-center'>
                            <div className='relative hover:scale-110 transition delay-150 duration-300 ease-in-out '>
